...
module.exports = class WarcraftSoundsAPIV1Model {
	...
	getRaces() {
		...
		return new Promise((resolve, reject) => {
			...
			this.db.all("SELECT code, name FROM races;", (err, data) => {
	...
	getRace(code) {
		...
		return new Promise((resolve, reject) => {
			...
			this.db.get(
				"SELECT id, code, name FROM races WHERE code = ?;"
			, [ code ], (err, data) => {
			...
			if (!race) {
				...
				return new Promise((resolve, reject) => {
					...
					this.db.all("SELECT code, name FROM characters WHERE k_race = ?;"
					, [ race.id ], (err, data) => {
					...
					return new Promise((resolve, reject) => {
						...
						this.db.all("SELECT code, name, file FROM musics WHERE k_race = ?;"
						, [ race.id ], (err, data) => {
					...
					return new Promise((resolve, reject) => {
						...
						this.db.all("SELECT code, name, file FROM warnings WHERE k_race = ?;"
						, [ race.id ], (err, data) => {
