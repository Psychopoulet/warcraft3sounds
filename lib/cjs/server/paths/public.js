...
function pathPublicIndex(req, res) {
    return res.sendFile((0, node_path_1.join)(__dirname, "..", "..", "..", "..", "public", "dist", "index.html"));
}
// app
function pathPublicApp(req, res) {
    return res.sendFile((0, node_path_1.join)(__dirname, "..", "..", "..", "..", "public", "dist", "bundle.min.js"));
}
function pathPublicAppMap(req, res) {
    return res.sendFile((0, node_path_1.join)(__dirname, "..", "..", "..", "..", "public", "dist", "bundle.min.js.map"));
}
// pictures
