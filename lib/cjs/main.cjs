...
const redirect_1 = require("./server/paths/redirect");
...
Promise.resolve().then(() => {
    ...
    // public
    app
        .get("/public/index.html", public_1.pathPublicIndex)
        .get("/public/bundle.min.js", public_1.pathPublicApp)
        .get("/public/bundle.min.js.map", public_1.pathPublicAppMap)
        .get("/public/pictures/warcraft3.png", public_1.pathPublicIconW3)
    ...
    // redirections
    app
        .get("/", (0, redirect_1.redirect)("/public/index.html"))
        .get("/index.html", (0, redirect_1.redirect)("/public/index.html"))
        .get("/public/bundle.js", (0, redirect_1.redirect)("/public/bundle.min.js"))
        .get("/public/bundle.js.map", (0, redirect_1.redirect)("/public/bundle.min.js.map"))
        .get("/favicon.ico", (0, redirect_1.redirect)("/public/pictures/warcraft3.png"))
        .get("/favicon.png", (0, redirect_1.redirect)("/public/pictures/warcraft3.png"));
    // errors
