...
// deps
	...
	// @TODO : add express-fileupload middleware
...
// module
	...
	CONF.load().then(() => {
		...
		APP
			...
			.use(helmet())
			.use(compression())
			// @TODO : add fileupload middleware
			// .use(fileupload())
		...
		.get("/public/app.js", (req, res) => {
			res.sendFile(join(__dirname, "web", "app.js"));
		})

		// pictures

		.get("/public/pictures/warcraft3.png", (req, res) => {
			res.sendFile(join(__dirname, "web", "pictures", "warcraft3.png"));
		})
		.get("/public/pictures/warcraft3TFT.png", (req, res) => {
			res.sendFile(join(__dirname, "web", "pictures", "warcraft3TFT.png"));
		})
